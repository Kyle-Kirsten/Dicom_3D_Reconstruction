...
PathDicom = "dicom_slices"  # 与python文件同一个目录下的文件夹
lstFilesDCM = []
...
pyplot.imshow(ArrayDicom[:, :, 360])# 第三个维度表示现在展示的是第几层 54 pyplot.show() 5556 # 冠状面显示 57 pyplot.figure(dpi=100) 58 pyplot.axes().set_aspect('equal', 'datalim') 59 pyplot.set_cmap(pyplot.gray()) 60 pyplot.imshow(ArrayDicom[:, 90, :])61 pyplot.show()